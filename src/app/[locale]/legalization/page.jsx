  ...
  return (
    <div className="legalization flex flex-col md:flex-row flex-grow">
      <div className="mx-auto md:max-w-[1200px] my-15 md:my-20">
        ...
        <h2
          className="text-2xl md:text-5xl text-[#704B40] text-center tracking-wide md:tracking-custom mt-10 md:mt-15 uppercase md:normal-case font-medium md:font-light px-5 xs:px-8 ms:px-10 xl:px-0"
        ...
        <p>{t('paragraph-1')}</p>
        <p>{t('paragraph-2')}</p>
        <div className="px-5 xs:px-8 ms:px-10 md:px-15 mt-10">
        ...
        <h3
          className="text-[#704B40] uppercase font-semibold text-center md:text-left text-xl xs:text-[22px] md:text-3xl py-6 tracking-widest px-5 xs:px-8 ms:px-10"
          style={{ fontFamily: 'var(--font-playfair-display)' }}
        >
          {t('advantages-title')}
        </h3>
        <ul className="px-5 xs:px-8 ms:px-10">
