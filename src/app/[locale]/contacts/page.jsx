...
export default function ContactsPage() {
  ...
  return (
    <div className="contacts flex flex-grow text-lg md:text-xl xl:text-[22px] 2xl:text-2xl items-center overflow-x-hidden">
      <div className="mx-auto max-w-[1200px] flex flex-col xl:flex-row gap-8 md:gap-15 w-full px-5 xs:px-8 ms:px-10 sm:px-15 md:px-20 2xl:px-0">
