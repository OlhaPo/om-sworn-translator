  ...
  return (
    <section className="flex flex-col flex-wrap justify-center md:flex-row md:justify-between max-w-[1200px] mx-auto 2xl:max-w-[1400px]">
      <div className="md:w-1/2 flex flex-col items-center 2xl:justify-center">
        ...
        />
        <h1
          className="flex flex-wrap justify-center gap-4 text-4xl ms:text-5xl md:text-6xl 2xl:text-7xl md:mt-0 mt-6 mb-4 md:mb-5 text-[#704B40] custom-text-shadow text-center order-2 md:tracking-wide"
          style={{ fontFamily: 'var(--font-playfair-display)' }}
        >
          {t('title-name')} {t('title-surname')}
        </h1>
        <h2
          className="text-2xl ms:text-3xl md:text-4xl text-[#704B40] md:mb-12 text-center order-3 leading-7 ms:leading-10 md:tracking-wide"
          style={{ fontFamily: 'var(--font-playfair-display)' }}
        >
          {t.rich('subtitle', {
            br: () => <br />,
